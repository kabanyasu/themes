...
function the_dp_logo(){
  ...
  if($logo){
    ...
    echo '<h1 id="logo"><a href="' . $url . '/" title="' . $title . '" data-label="' . $title . '"><img class="h_logo" src="' . $logo['url'] . '?' . time() . '" alt="' . $title . '" title="' . $title . '" /></a></h1>' . "\n";
    echo "</div>\n";
  } else {
...
function the_dp_footer_logo(){
  ...
  $url = home_url();
  if($logo){
    echo "<div id='footer_logo_image'>\n";
    echo '<h3 id="footer_logo"><a href="' . $url . '/" title="' . $title . '" data-label="' . $title . '"><img class="f_logo" src="' . $logo['url'] . '?' . time() . '" alt="' . $title . '" title="' . $title . '" /></a></h3>' . "\n";
    echo "</div>\n";
  } else {
    echo "<div id='footer_logo_text'>\n";
    echo '<h3 id="footer_logo"><a href="' . $url . '/">' . $title . "</a></h3>\n";
    echo "</div>\n";
  }
}
