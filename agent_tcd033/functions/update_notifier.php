	...
	<style>
        ...
        <div class="wrap">
         ...
         <div id="mono_instructions">
          ...
          <p style="font-size:16px;">【 <a href="https://dl.tcd-theme.com/tcd033/agent/agent_tcd033.zip">最新版のテーマをダウンロードする</a> 】</p>
          <div id="mono_info">
	   <h3>更新情報</h3>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://design-plus1.com/notifier_agent.xml';
