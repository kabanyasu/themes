...
<section class="container" style="<?php if(!isset($value)){ echo 'margin-top:215px;'; } ?> background:white">
...
<?php if($type2_headline5 || $type2_desc5 || !empty($type2_shortcode1)) { ?>
<div class="container">
...
<?php if($type2_headline6 || $type2_desc6 || !empty($type2_shortcode3)) { ?>
<div class="container">
  <div class="row<?php if(!is_mobile()){ echo ' mb40'; }; ?>">
    <div class="col-sm-120">
