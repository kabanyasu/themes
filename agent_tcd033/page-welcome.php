...
?>
  ...
  <div class="separator" id="service" data-parallax="scroll" data-speed="0.6" data-image-src="<?php echo $top_main_image3[0]; ?>">
    <div class="title">
      <div class="container">
        <div class="row">
...
/></div><?php }; ?>
 ...
  <div class="separator" id="about" data-parallax="scroll" data-speed="0.6" data-image-src="<?php echo $top_main_image5[0]; ?>">
    <div class="title">
      <div class="container">
        <div class="row">
          <div class="col-xs-120">
  ...
  <?php
    $top_content5_banner_image1 = wp_get_attachment_image_src($options['top_content5_banner_image1'], 'size1');
    $top_content5_banner_image2 = wp_get_attachment_image_src($options['top_content5_banner_image2'], 'size1');
    $top_content5_banner_image3 = wp_get_attachment_image_src($options['top_content5_banner_image3'], 'size1');
  ?>
  <div class="section container">
    <div class="row">
  ...
  <?php
    if($options['top_content6_contents']=='type2'):
  ...
  <?php elseif($options['top_content6_contents']=='type1'): ?>
  <?php
  if($options['order_by']=='type2'){
    $orderby = 'rand';
  }else{
    $orderby = 'date';
  }
    $args = array('post_type' => 'post', 'orderby' =>$orderby, 'numberposts' => $options['number_posts']);
