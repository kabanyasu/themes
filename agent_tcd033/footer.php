...
<div style="background:black; <?php if ( is_mobile()&&($options['footer_bar_display']==1||$options['footer_bar_display']==2) ) { echo ' padding-bottom:72px;'; }; ?>">
	<div class="container">
      ...
      <?php if(!is_mobile()){ ?>
        ...
        <?php if($options['facebook_url'] || $options['twitter_url'] || $options['insta_url'] || $options['pinterest_url'] || $options['flickr_url'] || $options['tumblr_url'] || $options['show_rss']): ?>
        <ul class="footer_sns_icon">
          <?php if($options['facebook_url']){ ?><li class="facebook"><a href="<?php echo $options['facebook_url']; ?>"><span>facebook</span></a></li><?php }; ?>
          <?php if($options['twitter_url']){ ?><li class="twitter"><a href="<?php echo $options['twitter_url']; ?>"><span>twitter</span></a></li><?php }; ?>
          <?php if($options['insta_url']){ ?><li class="instagram"><a href="<?php echo $options['insta_url']; ?>"><span>instagram</span></a></li><?php }; ?>
          <?php if($options['pinterest_url']){ ?><li class="pinterest"><a href="<?php echo $options['pinterest_url']; ?>"><span>pinterest</span></a></li><?php }; ?>
          <?php if($options['flickr_url']){ ?><li class="flickr"><a href="<?php echo $options['flickr_url']; ?>"><span>flickr</span></a></li><?php }; ?>
          <?php if($options['tumblr_url']){ ?><li class="tumblr"><a href="<?php echo $options['tumblr_url']; ?>"><span>tumblr</span></a></li><?php }; ?>
          <?php if($options['show_rss']){ ?><li class="rss"><a class="target_blank" href="<?php bloginfo('rss2_url'); ?>"><span>rss</span></a></li><?php }; ?>
        </ul>
        <?php endif; ?>
			</div>
      <?php }; ?>
      <div class="col-lg-offset-30 col-lg-60 col-lg-pull-30 text-center romaji copyright">Copyright <?php echo date("Y"); ?> <?php bloginfo('name'); ?></div>
